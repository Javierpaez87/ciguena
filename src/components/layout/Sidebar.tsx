...
const adminNav: NavItem[] = [
  ...
  { id: 'admin-training-catalog', label: 'Catálogo de Trainings', icon: <LibraryBig size={18} /> },
...
export default function Sidebar({ activeView, onNavigate }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Mobile sidebar */}
      <div className={`lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-steel-900 border-r border-steel-700 transform transition-transform duration-300 ${
      ...
      {/* Desktop sidebar */}
      <div className={`hidden lg:flex flex-col bg-steel-900 border-r border-steel-700 transition-all duration-300 ${
        collapsed ? 'w-16' : 'w-60'
