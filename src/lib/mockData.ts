...
export const mockTrainings: Training[] = [
  ...
  { id: 'tr11', title: 'Aislamiento de energía', description: 'Controles críticos para aislar fuentes de energía antes de intervenir equipos o instalaciones.', category: 'Seguridad', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
  { id: 'tr12', title: 'Línea de fuego', description: 'Prevención de incidentes por atrapamiento, golpes, energía liberada y exposición a trayectorias peligrosas.', category: 'Seguridad', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
  { id: 'tr13', title: 'Izaje mecánico seguro', description: 'Buenas prácticas para operaciones de izaje, control de cargas y prevención de incidentes durante maniobras.', category: 'Seguridad', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
  { id: 'tr14', title: 'Trabajo en caliente', description: 'Controles para tareas con fuentes de ignición, soldadura, corte y actividades con riesgo de incendio o explosión.', category: 'Seguridad', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
  { id: 'tr15', title: 'Autorización de trabajo', description: 'Principios de autorización previa, verificación de controles y condiciones seguras antes de iniciar tareas.', category: 'HSE', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
  { id: 'tr16', title: 'Bypass de controles de seguridad', description: 'Concientización sobre la prohibición de anular, desactivar o bypassar dispositivos y barreras críticas de seguridad.', category: 'Seguridad', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
  { id: 'tr17', title: 'Conducción segura', description: 'Hábitos de conducción segura para prevenir incidentes viales en rutas, caminos internos y traslados operativos.', category: 'Transporte', duration_minutes: 60, validity_months: 12, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2026-05-24T10:00:00Z', module_count: 1, tenant_count: 1 },
];
...
export const mockTenantTrainings: TenantTraining[] = [
  ...
  { id: 'tt13', tenant_id: 't1', training_id: 'tr4', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt14', tenant_id: 't1', training_id: 'tr11', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt15', tenant_id: 't1', training_id: 'tr12', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt16', tenant_id: 't1', training_id: 'tr13', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt17', tenant_id: 't1', training_id: 'tr14', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt18', tenant_id: 't1', training_id: 'tr15', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt19', tenant_id: 't1', training_id: 'tr16', enabled: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'tt20', tenant_id: 't1', training_id: 'tr17', enabled: true, created_at: '2026-05-24T10:00:00Z' },
];
...
export const mockModules: TrainingModule[] = [
  ...
  { id: 'm7', training_id: 'tr4', title: 'Espacios confinados: Introducción', description: 'Condiciones de ingreso, evaluación de atmósfera y controles esenciales para tareas en espacios confinados.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm8', training_id: 'tr11', title: 'Aislamiento de energía: Introducción', description: 'Controles para aislar y verificar energías peligrosas antes de comenzar trabajos.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm9', training_id: 'tr12', title: 'Línea de fuego: Introducción', description: 'Identificación de trayectorias de riesgo y prevención de exposición a energías y movimientos peligrosos.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm10', training_id: 'tr13', title: 'Izaje mecánico seguro: Introducción', description: 'Controles previos, planificación del izaje y seguridad durante maniobras con carga.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm11', training_id: 'tr14', title: 'Trabajo en caliente: Introducción', description: 'Control de fuentes de ignición y verificación de condiciones seguras para tareas en caliente.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm12', training_id: 'tr15', title: 'Autorización de trabajo: Introducción', description: 'Validación de permisos, controles y condiciones previas al inicio de tareas operativas.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm13', training_id: 'tr16', title: 'Bypass de controles de seguridad: Introducción', description: 'Importancia de no anular ni intervenir barreras críticas de seguridad.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
  { id: 'm14', training_id: 'tr17', title: 'Conducción segura: Introducción', description: 'Hábitos esenciales para la conducción segura en contexto operativo.', order_index: 1, created_at: '2026-05-24T10:00:00Z' },
];
...
export const mockLessons: TrainingLesson[] = [
  ...
  { id: 'l5', module_id: 'm5', title: 'Cuidado de Manos: Introducción', description: 'Video introductorio del mock de capacitación sobre cuidado y protección de manos.', lesson_type: 'video', video_provider: 'youtube', video_id: 'Ve4pR-x5h0A', video_embed_url: 'https://www.youtube.com/embed/Ve4pR-x5h0A', video_thumbnail_url: null, duration_seconds: 180, resource_url: 'https://youtube.com/shorts/Ve4pR-x5h0A?feature=share', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  ...
  { id: 'l7', module_id: 'm7', title: 'Espacios confinados: Life-Saving Rule', description: 'Video externo de referencia sobre ingreso y trabajo seguro en espacios confinados.', lesson_type: 'video', video_provider: 'youtube', video_id: '6vhQtzdffMo', video_embed_url: 'https://www.youtube.com/embed/6vhQtzdffMo', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=6vhQtzdffMo&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=8', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l8', module_id: 'm8', title: 'Aislamiento de energía: Life-Saving Rule', description: 'Video externo de referencia sobre aislamiento de energía y verificación previa de condiciones seguras.', lesson_type: 'video', video_provider: 'youtube', video_id: 'WagIdQYQVcc', video_embed_url: 'https://www.youtube.com/embed/WagIdQYQVcc', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=WagIdQYQVcc&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=6', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l9', module_id: 'm9', title: 'Línea de fuego: Life-Saving Rule', description: 'Video externo de referencia sobre prevención de exposición a trayectorias y puntos de impacto peligrosos.', lesson_type: 'video', video_provider: 'youtube', video_id: '3DJ9YZECdDk', video_embed_url: 'https://www.youtube.com/embed/3DJ9YZECdDk', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=3DJ9YZECdDk&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=4', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l10', module_id: 'm10', title: 'Izaje mecánico seguro: Life-Saving Rule', description: 'Video externo de referencia sobre controles críticos para maniobras de izaje mecánico.', lesson_type: 'video', video_provider: 'youtube', video_id: 'grXr9UgonYQ', video_embed_url: 'https://www.youtube.com/embed/grXr9UgonYQ', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=grXr9UgonYQ&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=3', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l11', module_id: 'm11', title: 'Trabajo en caliente: Life-Saving Rule', description: 'Video externo de referencia sobre identificación y control de fuentes de ignición.', lesson_type: 'video', video_provider: 'youtube', video_id: 't7K6UjJ5-_c', video_embed_url: 'https://www.youtube.com/embed/t7K6UjJ5-_c', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=t7K6UjJ5-_c&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=5', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l12', module_id: 'm12', title: 'Autorización de trabajo: Life-Saving Rule', description: 'Video externo de referencia sobre autorización previa y verificación de condiciones seguras antes de trabajar.', lesson_type: 'video', video_provider: 'youtube', video_id: 'e_T64yUQ_Ko', video_embed_url: 'https://www.youtube.com/embed/e_T64yUQ_Ko', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=e_T64yUQ_Ko&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=2', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l13', module_id: 'm13', title: 'Bypass de controles de seguridad: Life-Saving Rule', description: 'Video externo de referencia sobre la prohibición de anular dispositivos y controles críticos de seguridad.', lesson_type: 'video', video_provider: 'youtube', video_id: 'voB8KHodwiA', video_embed_url: 'https://www.youtube.com/embed/voB8KHodwiA', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=voB8KHodwiA&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=9', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
  { id: 'l14', module_id: 'm14', title: 'Conducción segura: Life-Saving Rule', description: 'Video externo de referencia sobre hábitos y decisiones clave para una conducción segura.', lesson_type: 'video', video_provider: 'youtube', video_id: 'hGWkHQnBk20', video_embed_url: 'https://www.youtube.com/embed/hGWkHQnBk20', video_thumbnail_url: null, duration_seconds: 60, resource_url: 'https://www.youtube.com/watch?v=hGWkHQnBk20&list=PLt0-qTVCvEp2I9MYBd0rqSdooubmkCgAf&index=7', order_index: 1, is_required: true, created_at: '2026-05-24T10:00:00Z' },
];
...
export const mockAssignments: TrainingAssignment[] = [
  ...
  { id: 'a11', tenant_id: 't1', training_id: 'tr4', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a12', tenant_id: 't1', training_id: 'tr11', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a13', tenant_id: 't1', training_id: 'tr12', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a14', tenant_id: 't1', training_id: 'tr13', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a15', tenant_id: 't1', training_id: 'tr14', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a16', tenant_id: 't1', training_id: 'tr15', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a17', tenant_id: 't1', training_id: 'tr16', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
  { id: 'a18', tenant_id: 't1', training_id: 'tr17', user_id: 'u1', assigned_by: 'admin1', status: 'not_started', progress_percentage: 0, assigned_at: '2026-05-24T10:00:00Z', due_date: '2026-06-24T10:00:00Z', started_at: null, completed_at: null, expires_at: null },
