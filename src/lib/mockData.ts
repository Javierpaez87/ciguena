...
export const mockTrainings: Training[] = [
  ...
  { id: 'tr2', title: 'Uso de EPP', description: 'Equipos de Protección Personal: selección, uso correcto y mantenimiento según normativa vigente.', category: 'Seguridad', duration_minutes: 60, validity_months: 24, certificate_enabled: true, passing_score: 80, max_attempts: 2, status: 'active', created_at: '2024-01-05T10:00:00Z', module_count: 3, tenant_count: 4 },
