...
return ( <div className="rounded-xl border border-steel-700 bg-steel-900 p-6 text-center"> <PlayCircle size={28} className="mx-auto mb-3 text-steel-500" /> <p className="text-sm font-medium text-steel-200 mb-1">
Este training todavía no tiene contenido cargado. </p> <p className="text-xs text-steel-500">
El contenido podrá ser un video, documento o recurso externo. </p> </div>
);
}
...
return ( <div className="space-y-4"> <div className="relative max-w-sm"> <Search size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-steel-400" />
<input
value={search}
