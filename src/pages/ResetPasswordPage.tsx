...
export default function ResetPasswordPage({
    ...
    return (
      <CardShell>
        ...
        <p className="mt-2 text-sm leading-relaxed text-steel-400">
          No pudimos validar tu sesión de recuperación de {branding.brandName}. Volvé a solicitar un nuevo enlace para cambiar tu contraseña.
        </p>
  ...
  if (success) {
    return (
      <CardShell>
        ...
        <p className="mt-2 text-sm leading-relaxed text-steel-400">
          Ya podés ingresar a {branding.brandName} con tu nueva contraseña.
        </p>
  ...
  return (
    <CardShell>
      ...
      <p className="mt-2 text-sm leading-relaxed text-steel-400">
        Ingresá una nueva contraseña para recuperar el acceso a {branding.brandName}.
      </p>
